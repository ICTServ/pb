...
wget $(curl -sL https://api.github.com/repos/pocketbase/pocketbase/releases/latest | jq -r ".assets[].browser_download_url" | grep _linux_amd64.zip) -O '/tmp/pocketbase.zip' &&
